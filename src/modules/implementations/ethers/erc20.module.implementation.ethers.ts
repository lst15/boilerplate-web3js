...
import {Erc20ModuleRepository} from "../../repositories/erc20.module.repository"
/**
 * Interface para a requisição de criação de um contrato ERC20.
 */
export interface Erc20ModuleImplementationEthersRequest {
  address: AddressType;
 ...
 */
class Erc20ModuleImplementationEthers implements Erc20ModuleRepository{
  _abi: any;
   ...
   */
  constructor({ address,signerOrProvider }: Erc20ModuleImplementationEthersRequest) {
...
export default Erc20ModuleImplementationEthers;

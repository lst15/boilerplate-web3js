 ...
 */
export type signerOrProviderType = ethers.Signer | ethers.providers.Provider | undefined;
 ...
 */
export type SystemPortType = number;
 ...
 */
export type SystemQueryType = string;
 ...
 */
export type TypeMnemonicType = string;
 ...
 */
export type EthersJsonRpcProviderType = ethers.providers.JsonRpcProvider;
 ...
 */
export type EthersWebSocketProviderType = ethers.providers.WebSocketProvider;
 ...
 */
export type HDNodeType = ethers.utils.HDNode;
 ...
 */
export type WalletType = ethers.Wallet;
 ...
 */
export type TransactionHashListType = Array<string>;
 ...
 */
export type CacheNameSpaceType = string;
 ...
 */
export type TransactionType = ethers.providers.TransactionResponse;
 ...
 */
export type AbiInterfaceType = ethers.utils.Interface;
 ...
 */
export type ByteCodeDescriptionType = ethers.utils.TransactionDescription;
 ...
 */
export type ByteCodeType = string;
